...
The files in this repository were used to configure the network depicted below.
 ...
 ![Network Diagram](https://user-images.githubusercontent.com/95192133/162588776-a61094c1-119e-488a-bcc4-ae16df0e5578.png)
...
| JumpBox | Gateway  |  10.0.0.5    |  Linux(ubtntu 18.04)|           
| Web-1   | Server   |  10.0.0.6    |  Linux(ubtntu 18.04)|                     
| Web-2   | Server   |  10.0.0.7    |  Linux(ubtntu 18.04)|                       
| Elk-VM1 | ElkServer|  10.1.0.4    |  Linux(ubtntu 18.04)|
...
- Add whitelisted IP addresses:-
    	- Public IP address which changes everytime when the VM is on/off eg of Public IP 73.252.149.24/32

Machines within the network can only be accessed by SSH.

- Which machine did you allow to access your ELK VM? What was its IP address? JumpBox VM, its private Ip address(Vnet IP)-10.0.0.5
...
The following screenshot displays the result of running `docker ps` after successfully configuring the ELK instance.
 ![docker](https://user-images.githubusercontent.com/95192133/162588788-9f3f8283-6d91-465f-8c4d-15d77e9fd916.PNG)
...
Click 'Explore On Your Own' and you should see the following:
 ...
 ![Kibana_dashboard](https://user-images.githubusercontent.com/95192133/162588794-c65d8653-82e4-4136-b361-cb29ee970466.PNG)
...
- Create a new playbook in the /etc/ansible/roles/ directory that will install, drop in the updated configuration file, enable and configure system module, run the metricbeat setup, and start the metricbeat service. 
 ...
 ![Filebeat_syslogs](https://user-images.githubusercontent.com/95192133/162588800-c4a947e3-42d6-4e7a-aabe-3759ac15bac2.PNG)


   The commands needed to run the Ansible configuration for the Elk-Server are:

	- ssh jobara@JumpBox(Public IP)
